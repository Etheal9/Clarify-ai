...
export const TeachSection: React.FC<TeachSectionProps> = ({ initialTopic = '' }) => {
  ...
  if (!isSessionActive) {
      return (
          <div className="h-full flex flex-col items-center justify-center p-4 animate-fade-in bg-white dark:bg-black transition-colors">
              <div className="max-w-md w-full text-center space-y-8">
                  <div className="w-24 h-24 bg-pink-50 dark:bg-pink-900/20 rounded-3xl mx-auto flex items-center justify-center rotate-3">
                  ...
                  <div className="bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-2 shadow-lg focus-within:border-pink-500 transition-colors">
                      <input 
                        type="text"
                        value={topic}
                  ...
                  <Button 
                    ...
                    className="w-full py-4 text-lg bg-pink-600 hover:bg-pink-700 dark:bg-pink-600 dark:hover:bg-pink-500 text-white rounded-xl font-bold shadow-xl transition-transform active:scale-95"
                  >
  ...
  return (
      <div className="h-full flex flex-col bg-gray-50 dark:bg-black transition-colors">
          ...
          {/* Header */}
          <div className="h-16 px-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between shadow-sm z-10">
                    ...
                    <div key={msg.id} className={`flex ${isModel ? 'justify-start' : 'justify-end'} animate-fade-in`}>
                        <div className={`flex gap-3 max-w-[85%] sm:max-w-[75%] ${isModel ? 'flex-row' : 'flex-row-reverse'}`}>
                            ...
                            <div className={`w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center mt-1 
                                ${isModel ? 'bg-pink-100 dark:bg-pink-900/40 text-pink-600' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300'}`}>
              ...
              {isProcessing && (
                  <div className="flex justify-start animate-fade-in">
                      <div className="flex gap-3 max-w-[75%]">
                          <div className="w-8 h-8 bg-pink-100 dark:bg-pink-900/40 rounded-full flex items-center justify-center mt-1">🎓</div>
                          <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl rounded-tl-none border border-gray-100 dark:border-gray-700 flex gap-1 items-center h-12">
          ...
          <div className="p-4 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
              <div className="max-w-4xl mx-auto flex items-end gap-3">
                  ...
                  <button 
                    ...
                    className={`p-4 rounded-full transition-all duration-200 flex-shrink-0 shadow-md border-2
                        ${isRecording 
                            ...
                            : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-pink-500 hover:text-pink-500'}
                    `}
                    title="Hold to Speak"
                  >
                  ...
                  {/* Text Input */}
                  <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-2xl flex items-center px-4 py-2 border border-transparent focus-within:border-gray-300 dark:focus-within:border-gray-600 transition-colors">
                      <input 
                        type="text" 
                        value={inputText}
